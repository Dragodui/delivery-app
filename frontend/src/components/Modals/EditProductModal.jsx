...
const EditProductModal = ({ productId, isVisible, setIsVisible, setIsEdit, isEdit }) => {
  ...
  return (
    ...
    >
      <form
        className='bg-textWhite px-10 flex flex-col w-full gap-4 max-w-[800px] py-8 rounded-xl'
        onClick={(e) => e.stopPropagation()}
      >
        <div className='table-container table-class w-full'>
        <h1 className='text-3xl font-bold font-heading mb-[30px]'>Edit product</h1>
