...
const AddResModal = ({ isVisible, setIsVisible }) => {
  ...
  return (
    <div
      ...
      className={`fixed flex items-center justify-center top-0 left-0 right-0 bottom-0 bg-[#0000004d]`}
    >
      <form
        className='bg-white px-10 flex flex-col w-full gap-4 max-w-[600px] py-8 rounded-xl'
